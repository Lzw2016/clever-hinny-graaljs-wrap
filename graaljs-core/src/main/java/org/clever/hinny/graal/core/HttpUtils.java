...
public class HttpUtils {
    ...
    private final org.clever.hinny.core.HttpUtils delegate;

    private HttpUtils() {
        delegate = org.clever.hinny.core.HttpUtils.Instance;
    }
     ...
     * @param headers 请求头
     */
    public org.clever.hinny.core.HttpUtils.HttpResponse execRequest(final String method, String url, Object body, Map<String, Object> params, Map<String, Object> headers) {
        body = InteropScriptToJavaUtils.Instance.deepToJavaObject(body);
        params = InteropScriptToJavaUtils.Instance.convertMap(params);
        headers = InteropScriptToJavaUtils.Instance.convertMap(headers);
