...
public class ValidatorUtils {
    ...
    private final org.clever.hinny.core.ValidatorUtils delegate;
     ...
     * @param rule 校验规则
     */
    public org.clever.hinny.core.ValidatorUtils.ValidResult valid(Map<String, Object> bean, Map<String, Object> rule) {
        Map<String, Object> ruleMap = new HashMap<>();
        if (bean != null && rule != null) {
            convertRule(bean, rule, ruleMap);
        }
    ...
    protected void convertRule(Map<String, Object> bean, Map<String, Object> rule, Map<String, Object> ruleMap) {
        for (Map.Entry<String, Object> entry : rule.entrySet()) {
            ...
            if (!(value instanceof Map)) {
                org.clever.hinny.core.ValidatorUtils.ValidatorRuleItem validatorRuleItem = doConvertRule((Map<String, Object>) ruleItem);
    ...
    protected org.clever.hinny.core.ValidatorUtils.ValidatorRuleItem doConvertRule(Map<String, Object> ruleItem) {
        org.clever.hinny.core.ValidatorUtils.ValidatorRuleItem validatorRuleItem = new org.clever.hinny.core.ValidatorUtils.ValidatorRuleItem();
        ...
        if (validator != null && validator.getClass().getName().startsWith("com.oracle.truffle.polyglot.")) {
            ...
            if (fucTmp.canExecute()) {
                Function<org.clever.hinny.core.ValidatorUtils.ValidatorContext, Boolean> validatorFuc = context -> {
    ...
    protected org.clever.hinny.core.ValidatorUtils.RuleItemRange convertRange(Map<String, Object> rangeMap) {
        org.clever.hinny.core.ValidatorUtils.RuleItemRange range = new org.clever.hinny.core.ValidatorUtils.RuleItemRange();
    ...
    protected org.clever.hinny.core.ValidatorUtils.RuleItemLength convertLength(Map<String, Object> lengthMap) {
        org.clever.hinny.core.ValidatorUtils.RuleItemLength length = new org.clever.hinny.core.ValidatorUtils.RuleItemLength();
    ...
    protected org.clever.hinny.core.ValidatorUtils.RuleItemDigits convertDigits(Map<String, Object> digitsMap) {
        org.clever.hinny.core.ValidatorUtils.RuleItemDigits digits = new org.clever.hinny.core.ValidatorUtils.RuleItemDigits();
    ...
    @SuppressWarnings("DuplicatedCode")
    protected org.clever.hinny.core.ValidatorUtils.RuleItemSize convertSize(Map<String, Object> sizeMap) {
        org.clever.hinny.core.ValidatorUtils.RuleItemSize size = new org.clever.hinny.core.ValidatorUtils.RuleItemSize();
