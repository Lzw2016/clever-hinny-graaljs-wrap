...
public class RedisDatabase extends AbstractRedisDatabase {
     ...
     */
    public void setDefault(String defaultName, org.clever.hinny.data.redis.RedisDataSource redisDataSource) {
        Assert.hasText(defaultName, "参数defaultName不能为空");
     ...
     */
    public void add(String name, org.clever.hinny.data.redis.RedisDataSource redisDataSource) {
    ...
    public RedisDataSource add(String name, Map<String, Object> config) {
        ...
        org.clever.hinny.data.redis.RedisDataSource redisDataSource = new org.clever.hinny.data.redis.RedisDataSource(redisConfig.getRedisProperties());
