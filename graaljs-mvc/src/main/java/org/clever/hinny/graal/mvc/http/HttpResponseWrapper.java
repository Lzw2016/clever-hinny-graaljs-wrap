...
public class HttpResponseWrapper {
    ...
    private final org.clever.hinny.mvc.http.HttpResponseWrapper delegate;
    ...
    protected HttpResponseWrapper(org.clever.hinny.mvc.http.HttpResponseWrapper response) {
    ...
    public HttpServletResponse originalResponse() {
        return delegate.originalResponse();
    }
