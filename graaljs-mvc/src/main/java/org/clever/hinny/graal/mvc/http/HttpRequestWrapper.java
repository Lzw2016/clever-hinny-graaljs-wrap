...
public class HttpRequestWrapper {
    ...
    private final org.clever.hinny.mvc.http.HttpRequestWrapper delegate;
    ...
    protected HttpRequestWrapper(org.clever.hinny.mvc.http.HttpRequestWrapper request) {
    ...
    public HttpSessionWrapper getSession(boolean create) {
        org.clever.hinny.mvc.http.HttpSessionWrapper session = delegate.getSession();
