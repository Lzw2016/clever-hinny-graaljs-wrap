...
public class ServletContextWrapper {
    ...
    private final org.clever.hinny.mvc.http.ServletContextWrapper delegate;

    protected ServletContextWrapper(org.clever.hinny.mvc.http.ServletContextWrapper servletContext) {
