...
public class HttpSessionWrapper {
    ...
    private final org.clever.hinny.mvc.http.HttpSessionWrapper delegate;

    protected HttpSessionWrapper(org.clever.hinny.mvc.http.HttpSessionWrapper session) {
    ...
    public HttpSession originalSession() {
        return delegate.originalSession();
    }
